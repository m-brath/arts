  ...
  */
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      OUT("cloudbox_field",
          ...
          "convergence_flag_doit",
          "iteration_counter_doit"),
      GOUT(),
      GOUT_TYPE(),
      GOUT_DESC(),
      IN("atmfields_checked",
      ...
      GIN_DESC(
          ...
          "Refinement criterion in terms of Log10 of ratio of two adjacent points of the total extinction.\n"
          "If set to -1 no refinement is done.",
          "Minimum optical thickness for refinement",
          "Number of points to be inserted by refinement per decade of change of total extinction",
          "Index whether to accelerate only the intensity (1) or the whole Stokes Vector (4)",
          "Index whether to use the forward scattering corretion (1) or not (0).",
