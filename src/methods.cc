...
- ``linear_mu``:
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      DESCRIPTION(
          ...
          "basename.speciesname.xml (for temperature and altitude the\n"
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      GOUT_DESC("Regridded gridded field."),
      IN("p_grid"),
      GIN("input", "interp_order", "zeropadding"),
...
*/
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      DESCRIPTION(
          ...
          "spectral irradiance at the sun's position.\n"
          "\n"
          "Unit:\n"
          "\n"
  ...
  md_data_raw.push_back(create_mdrecord(
      ...
      DESCRIPTION(
          ...
          "The sun spectrum is expected to be stored as\n"
          "spectral irradiance.\n"
          "It is coverted to the spectral irradiance at the sun's position.\n"
          "\n"
          "Unit:\n"
          "\n"
          "- GriddedField2: [W m-2 Hz-1]\n"
